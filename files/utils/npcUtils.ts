...
interface NPCResponse {
    ...
    response: string;   // The NPC's response
}

export class NPCMatcher {
    private model: use.UniversalSentenceEncoder | null = null;
    private responseEmbeddings: tf.Tensor | null = null;
    ...
    async initialize(): Promise<void> {
        ...
        this.responseEmbeddings = await this.model.embed(allIntents);
    ...
    async findBestResponse(input: string): Promise<string> {
        ...
        const scores = tf.matMul(inputEmbedding, this.responseEmbeddings.transpose());
        ...
        for (const response of this.responses) {
            if (bestMatchIndex < currentIndex + response.intents.length) {
                console.log('Found matching response:', response.response);
...
const npcs : Array<NPC> = [
    {
        ...
        Responses: [
            ...
            },
            {
                ...
                response: "Well, I'm Timmy! How are you?"
            },
            {
                intents: [
                    "I'm good",
                ...
                response: "Well wowie! How about that! That's so great."
            },
            {
                intents: [
                    "I'm bad",
                ...
                response: "Aww man, I'm so sorry to hear that, I sure do hope your day gets better."
            },
            {
                intents: [
                    "What do you do?",
                ...
                response: "Well mostly I farm, though papa says I outta stop."
            },
            {
                intents: [
                    "Why are you here?",
                ...
                response: "Well I was just heading out to the shops and found all you people, and shucks it sure is an honor."
            },
            {
                intents: [
                ...
                response: "Well papa had me run into town to pick him up some new tools!"
            },
            {
                intents: [
                ...
                response: "Oh I have a whole list of tools for papa! But it's super secret! :)"
            },
            {
                intents: [
                    "How are you?",
                ...
                response: "I'm great! A little sleepy... but great!"
            },
            {
                intents: [
                    "Why are you sleepy?",
                ...
                response: "Well I was just tossing and turning all night last night, couldn't get a wink of sleep!"
            },
            {
                intents: [
                ...
                response: "Well there was a mighty loud banging from papas workshop, he likes to work late into the nights."
            },
            {
                intents: [
                    "Who is your father?",
            ...
            },
            {
                ...
                response: "Papa is the best in the whole world! He gives me delicious food, a warm place to sleep, and all the happiness I could ask for!"
            },
            {
                intents: [
                    "How old are you?",
                ...
                response: "Well shucks, I just turned 11 this past summer!"
            },
            {
                intents: [
                    "Where do you live?",
                ...
                response: "Why I live just up the road, on my papas farm! We make all sorts of delicious fruits and veggies!"
            },
            {
                intents: [
                    "What do you grow?",
                ...
                response: "Well we make plums... and apples, and carrots, and pumpkins, and why we have this big old potato patch - oh, but I'm not allowed to go there."
            },
            {
                intents: [
                ...
                response: "Papa just says I'm not allowed, that's all!"
            },
            {
                intents: [
                ...
                response: "Well I have all of you as friends, don't I? Oh boy, how exciting."
            },
            {
                intents: [
                ...
                response: "I love to run around all day! Sometimes I play this fun game called 'pick up sticks'! What a hoot!"
            },
            {
                intents: [
                    "Whats your favorite color?",
                ],
                response: "Oh oh oh, I'm not sure, I think I like blue... but last week it was green."
            },
            {
                intents: [
                    "you're dumb",
                ...
                response: "I'm trying to get smarter, I promise!"
            },
            {
                intents: [
                    "go to sleep",
                ...
                response: "I don't wanna sleep! I'm not even tired."
            },
            {
                intents: [
                ...
                response: "My favorite food is absolutely without a doubt the big ole PUMPKINS my papa grows!"
            },
            {
                intents: [
                    "Do you get paid?",
                ...
                response: "I don't get a single coin for being here!"
            },
            {
                intents: [
                    "Do you need a union?",
            ...
            },
            {
                ...
                response: "I'm right where I want to be :)"
            },
            {
                intents: [
                    "Your dad is a farmer?",
                ],
                response: "He sure is! My papa loves to farm"
            },
            {
                intents: [
                    "I don't like Timmy",
            ...
            },
            {
                ...
                response: "Oh yeah! I bet my papa I can run to the barn first, but he always wins."
            },
            {
                intents: [
                    "Is a good boy",
                ],
                response: "Wowie thanks! I'm trying my best"
            },
            {
                intents: [
                    "Do you like jazz?",
                ],
                response: "I bet I do, I've never heard it but I'm sure it sounds great!"
            },
            {
                intents: [
                    "Timmy isn't smart",
                ],
                response: "Well shucks, sorry I'm trying my best"
            },
            {
                intents: [
                    "What dnd class would you be?",
                ],
                response: "Uhhh, hmmm, I think I'd be a druid! I love plants!"
            },
            {
                intents: [
                    "pokemon",
                ],
                response: "I've never played Pokemon!"
            },
        ]
    }
];
...
export async function GetNPCResponse(npc: NPC, message: string): Promise<string> {
    ...
    const response = await matcher.findBestResponse(message.toLowerCase().replace(npc.Name.toLowerCase(), ""));
