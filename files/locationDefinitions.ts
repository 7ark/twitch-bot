...
export const AllLocations: Array<MapLocation<any>> = [
    {
        ...
        PluralizedName: `settlements`,
        Type: LocationType.Settlement,
        NavigationCost: 1,
        NavigationTimeInTicks: 1,
        DangerRating: 1,
        Info: {
    ...
    },
    {
        ...
        PluralizedName: `ocean`,
        Type: LocationType.Wilderness,
        NavigationCost: 100,
        NavigationTimeInTicks: 5,
        DangerRating: 4,
        Info: {
...

    {
        ...
        PluralizedName: `tundra`,
        Type: LocationType.Wilderness,
        NavigationCost: 2,
        NavigationTimeInTicks: 3,
        DangerRating: 3,
        Info: {
...

    {
        ...
        PluralizedName: `mountains`,
        Type: LocationType.Wilderness,
        NavigationCost: 40,
        NavigationTimeInTicks: 2,
        DangerRating: 8,
        Info: {
...

    {
        ...
        PluralizedName: `desert`,
        Type: LocationType.Wilderness,
        NavigationCost: 5,
        NavigationTimeInTicks: 6,
        DangerRating: 5,
        Info: {
...

    {
        ...
        PluralizedName: `forests`,
        Type: LocationType.Wilderness,
        NavigationCost: 5,
        NavigationTimeInTicks: 4,
        DangerRating: 4,
        Info: {
...

    {
        ...
        PluralizedName: `wasteland`,
        Type: LocationType.Wilderness,
        NavigationCost: 15,
        NavigationTimeInTicks: 8,
        DangerRating: 12,
        Info: {
...

    {
        ...
        PluralizedName: `volcanos`,
        Type: LocationType.Wilderness,
        NavigationCost: 40,
        NavigationTimeInTicks: 12,
        DangerRating: 15,
        Info: {
